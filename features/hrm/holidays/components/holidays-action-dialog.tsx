      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className='sm:max-w-lg'>
          <DialogHeader className='text-start'>
            ...
            <DialogDescription>
              {isEdit
                ? 'Update the holiday details here. '
                : 'Create a new holiday here. '}
  ...
  return (
    ...
    >
      <FieldGroup>
        <Field
          data-invalid={
            !!form.formState.errors.from_date || !!form.formState.errors.to_date
          }
        >
          <FieldLabel>
          ...
          {form.formState.errors.from_date && (
            <FieldError errors={[form.formState.errors.from_date]} />
          )}
          {form.formState.errors.to_date && (
            <FieldError errors={[form.formState.errors.to_date]} />
          )}
        </Field>
          ...
          render={({ field, fieldState }) => (
            ...
            >
              <div className='space-y-0.5'>
                <FieldLabel htmlFor='holiday-recurring'>
                  Recurring Annually
                </FieldLabel>
                <FieldDescription>
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            ...
            >
              <div className='space-y-0.5'>
                <FieldLabel htmlFor='holiday-approved'>
                  Approved Status
                </FieldLabel>
                <FieldDescription>
