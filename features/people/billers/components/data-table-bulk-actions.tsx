...
import { useBulkActivateBillers, useBulkDeactivateBillers } from '../api'
...
export function DataTableBulkActions<TData>({
  ...
  const { mutate: activateBillers, isPending: isActivating } =
    useBulkActivateBillers()
  const { mutate: deactivateBillers, isPending: isDeactivating } =
