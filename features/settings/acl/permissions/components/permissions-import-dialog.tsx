...
import { permissionImportSchema, type PermissionImportFormData } from '@/features/settings/acl/permissions/schemas'
...
export function PermissionsImportDialog({
  ...
  const form = useForm<PermissionImportFormData>({
    resolver: zodResolver(permissionImportSchema),
    defaultValues: {
      file: [],
    },
  })
  ...
  const handlePreview = (data: PermissionImportFormData) => {
        ...
        <Controller
          ...
          render={({ field: { value, onChange, ...fieldProps }, fieldState }) => (
            <Field data-invalid={!!fieldState.error}>
              ...
              <FieldDescription>
                Upload the file containing your permissions data.
              </FieldDescription>
