...
export function DocumentTypesImportDialog({
  ...
  const form = useForm<DocumentTypeImportFormData>({
    resolver: zodResolver(documentTypeImportSchema),
    defaultValues: {
      file: [],
    },
  })
  ...
  const handlePreview = (data: DocumentTypeImportFormData) => {
