...
export default async function RootLayout({
  ...
  const activeColor =
    themeColors[themeName]?.color || themeColors['neutral'].color

  return (
    <html
      lang='en'
      className={`${outfit.variable} ${inter.variable} ${notoSans.variable} ${figtree.variable} ${roboto.variable} ${raleway.variable} ${dmSans.variable} ${publicSans.variable} ${jetbrainsMono.variable}`}
