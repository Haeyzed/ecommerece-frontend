...
import {
  ...
  EmploymentTypesEmptyState,
  employmentTypesColumns as columns,
} from '@/features/hrm/employment-types'
import { usePaginatedEmploymentTypes } from '@/features/hrm/employment-types/api'
...
export function EmploymentTypesTable() {
  ...
  const { data, isLoading, error } = usePaginatedEmploymentTypes(apiParams)
  ...
  if (!isLoading && !hasData && !isFiltered) {
    return <EmploymentTypesEmptyState />
  }
