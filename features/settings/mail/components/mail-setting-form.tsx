      ...
      <Card>
        <CardHeader>
          ...
          <p className='text-sm text-muted-foreground'>
            Configure mail driver, host, and credentials. Fields marked with *
            are required.
          </p>
        </CardHeader>
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  ...
                  <Input
                    id='encryption'
                    placeholder='e.g. tls, ssl, or empty'
                    {...field}
                    value={field.value ?? ''}
                  />
                  {fieldState.error && (
              ...
              render={({ field }) => (
                <Field className='flex flex-row items-center justify-between rounded-md border p-4'>
                  <div className='space-y-0.5'>
                    <FieldLabel htmlFor='send_test'>
                      Send test email after saving
                    </FieldLabel>
                    <FieldDescription>
                      A test email will be sent to the From Address after
                      updating settings.
                    </FieldDescription>
                  </div>
                  <Switch
