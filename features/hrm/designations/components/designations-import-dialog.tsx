...
import {
  type DesignationImportFormData,
  designationImportSchema,
  DesignationsCsvPreviewDialog,
  useDesignationsImport,
  useDesignationsTemplateDownload,
    ...
    <form id="import-form" onSubmit={form.handleSubmit(handlePreview)} className="grid gap-4 py-4">
      ...
      <FieldGroup>
        <div className="space-y-2 rounded-md border bg-muted/50 p-3 text-sm">
          ...
          <ul className="list-disc list-inside space-y-1 text-muted-foreground">
            <li><code className="rounded bg-background px-1 py-0.5 text-xs">department_id</code> - Parent Department ID
            </li>
