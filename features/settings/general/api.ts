  ...
  return useMutation({
    mutationFn: async (data: GeneralSettingFormData) => {
      ...
      if (data.is_rtl !== undefined)
        formData.append('is_rtl', data.is_rtl ? '1' : '0')
      if (data.is_zatca !== undefined)
        formData.append('is_zatca', data.is_zatca ? '1' : '0')
      if (data.company_name != null)
        formData.append('company_name', data.company_name)
      if (data.vat_registration_number != null)
      ...
      if (data.currency_position != null)
        formData.append('currency_position', data.currency_position)
      if (data.decimal != null) formData.append('decimal', String(data.decimal))
      if (data.staff_access != null)
        formData.append('staff_access', data.staff_access)
      if (data.without_stock != null)
        formData.append('without_stock', data.without_stock)
      if (data.is_packing_slip !== undefined)
        formData.append('is_packing_slip', data.is_packing_slip ? '1' : '0')
      if (data.date_format != null)
        formData.append('date_format', data.date_format)
      if (data.developed_by != null)
        formData.append('developed_by', data.developed_by)
      if (data.invoice_format != null)
        formData.append('invoice_format', data.invoice_format)
      if (data.state != null) formData.append('state', String(data.state))
      if (data.default_margin_value != null)
        formData.append(
          'default_margin_value',
          String(data.default_margin_value)
        )
      ...
      if (data.expiry_alert_days != null)
        formData.append('expiry_alert_days', String(data.expiry_alert_days))
      if (data.disable_signup !== undefined)
        formData.append('disable_signup', data.disable_signup ? '1' : '0')
      if (data.disable_forgot_password !== undefined)
        formData.append(
          'disable_forgot_password',
          data.disable_forgot_password ? '1' : '0'
        )
      if (data.maintenance_allowed_ips != null)
        formData.append('maintenance_allowed_ips', data.maintenance_allowed_ips)
      if (data.margin_type != null)
        formData.append('margin_type', String(data.margin_type))
      if (data.timezone != null) formData.append('timezone', data.timezone)
      if (data.show_products_details_in_sales_table !== undefined)
        formData.append(
          'show_products_details_in_sales_table',
          data.show_products_details_in_sales_table ? '1' : '0'
        )
      if (data.show_products_details_in_purchase_table !== undefined)
        formData.append(
          'show_products_details_in_purchase_table',
          data.show_products_details_in_purchase_table ? '1' : '0'
        )

      const response = await api.post<GeneralSetting>(
        '/settings/general',
        formData
      )
