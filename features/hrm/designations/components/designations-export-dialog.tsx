...
import {
  type DesignationExportFormData,
  designationExportSchema,
} from '@/features/hrm/designations/schemas'
...
export function DesignationsExportDialog({
  open,
  onOpenChange,
  ids = [],
        ...
        <DialogContent className='max-h-[90vh] overflow-y-auto sm:max-w-2xl'>
          <DialogHeader className='text-start'>
            ...
            <DialogDescription>
              ...
              {ids.length > 0 && `${ids.length} designation(s) selected.`}
            </DialogDescription>
          </DialogHeader>
