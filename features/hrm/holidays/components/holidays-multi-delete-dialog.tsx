...
export function HolidaysMultiDeleteDialog<TData>({
  ...
  const { mutate: bulkDestroy, isPending } = useBulkDestroyHolidays()
    ...
    <ConfirmDialog
      ...
      title={
        <span className='text-destructive'>
          ...
          {selectedRows.length > 1 ? 'holidays' : 'holiday'}
        </span>
      }
      desc={
        <div className='space-y-4'>
          <p className='mb-2'>
            Are you sure you want to delete the selected holidays? <br />
