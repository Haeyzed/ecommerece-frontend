      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className='sm:max-w-lg'>
          <DialogHeader className='text-start'>
            ...
            <DialogDescription>
              {isEdit
                ? 'Update the shift details here. '
                : 'Create a new shift here. '}
    ...
    >
      <FieldGroup>
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={!!fieldState.error}>
              <FieldLabel htmlFor='grace-in'>
                Grace In (mins) <span className='text-destructive'>*</span>
              </FieldLabel>
              <Input
                id='grace-in'
                type='number'
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={!!fieldState.error}>
              <FieldLabel htmlFor='grace-out'>
                Grace Out (mins) <span className='text-destructive'>*</span>
              </FieldLabel>
              <Input
                id='grace-out'
                type='number'
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={!!fieldState.error}>
              <FieldLabel htmlFor='total-hours'>
