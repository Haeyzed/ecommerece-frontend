...
import { DataTableBulkActions, timezonesColumns as columns, TimezonesEmptyState } from '@/features/settings/timezones'
...
export function TimezonesTable() {
  ...
  return (
    ...
    >
      <DataTableToolbar
        table={table}
        searchPlaceholder="Filter timezones by name..."
        searchKey="name"
        filters={[]}
      />
