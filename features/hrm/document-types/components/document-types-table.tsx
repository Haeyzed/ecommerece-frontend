...
import {
  ...
  DocumentTypesEmptyState,
  documentTypesColumns as columns,
} from '@/features/hrm/document-types'
import { usePaginatedDocumentTypes } from '@/features/hrm/document-types/api'
...
export function DocumentTypesTable() {
  ...
  const { data, isLoading, error } = usePaginatedDocumentTypes(apiParams)
