...
import { useTimezones } from '@/features/settings/timezones/api'
import { TimezonesEmptyState } from './timezones-empty-state'
import { timezonesColumns as columns } from './timezones-columns'
...
export function TimezonesTable() {
  ...
  const { data, isLoading, error } = useTimezones(apiParams)
  ...
  if (!isLoading && !hasData && !isFiltered) return <TimezonesEmptyState />

  return (
    <div className={cn('max-sm:has-[div[role="toolbar"]]:mb-16', 'flex flex-1 flex-col gap-4')}>
      <DataTableToolbar table={table} searchPlaceholder="Filter timezones..." searchKey="name" />
