...
import { useCities } from '@/features/settings/cities/api'
import { CitiesEmptyState } from './cities-empty-state'
...
export function CitiesTable() {
  ...
  const { data, isLoading, error } = useCities(apiParams)
  ...
  if (!isLoading && !hasData && !isFiltered) return <CitiesEmptyState />

  return (
    <div className={cn('max-sm:has-[div[role="toolbar"]]:mb-16', 'flex flex-1 flex-col gap-4')}>
      <DataTableToolbar table={table} searchPlaceholder="Filter cities..." searchKey="name" />
