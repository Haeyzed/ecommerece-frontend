...
import { type EmployeeImportFormData, employeeImportSchema } from '@/features/hrm/employees/schemas'
    ...
    <form id="import-form" onSubmit={form.handleSubmit(handlePreview)} className="grid gap-4 py-4">
      ...
      <FieldGroup>
        <div className="space-y-2 rounded-md border bg-muted/50 p-3 text-sm">
          ...
          <ul className="list-disc list-inside space-y-1 text-muted-foreground">
            <li><code className="rounded bg-background px-1 py-0.5 text-xs">email</code>, <code
              className="rounded bg-background px-1 py-0.5 text-xs">phone_number</code>, <code
              className="rounded bg-background px-1 py-0.5 text-xs">address</code></li>
            <li><code className="rounded bg-background px-1 py-0.5 text-xs">country_id</code>, <code
              className="rounded bg-background px-1 py-0.5 text-xs">state_id</code>, <code
              className="rounded bg-background px-1 py-0.5 text-xs">city_id</code></li>
            <li><code className="rounded bg-background px-1 py-0.5 text-xs">is_active</code>, <code
              className="rounded bg-background px-1 py-0.5 text-xs">is_sale_agent</code></li>
          </ul>
        </div>
        <Controller
