...
import {
  type CustomerGroupExportFormData,
  customerGroupExportSchema,
} from '../schemas'
...
type CustomerGroupsExportDialogProps = {
  open: boolean
...
export function CustomerGroupsExportDialog({
  ...
  const form = useForm<CustomerGroupExportFormData>({
    resolver: zodResolver(customerGroupExportSchema),
    defaultValues: {
      format: 'excel',
      method: 'download',
      columns: ['id', 'name', 'percentage', 'is_active'],
    },
  })
  ...
  const onSubmit = (data: CustomerGroupExportFormData) => {
        ...
        <DialogContent className='max-h-[90vh] overflow-y-auto sm:max-w-2xl'>
          <DialogHeader className='text-start'>
            ...
            <DialogDescription>
              ...
              {ids.length > 0 && `${ids.length} customer group(s) selected.`}
            </DialogDescription>
          </DialogHeader>
