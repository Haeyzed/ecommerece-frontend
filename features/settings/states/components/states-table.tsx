...
import { DataTableBulkActions, statesColumns as columns, StatesEmptyState } from '@/features/settings/states'
...
export function StatesTable() {
  ...
  return (
    ...
    >
      <DataTableToolbar
        table={table}
        searchPlaceholder="Filter states by name..."
        searchKey="name"
        filters={[]} // States do not have an active/inactive status like countries
      />
