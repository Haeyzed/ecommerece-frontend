...
export const employmentTypeSchema = z.object({
  name: z
    .string()
    .min(1, 'Employment type name is required')
    .max(255, 'Name is too long'),
  is_active: z.boolean().nullable().optional(),
})

export const employmentTypeImportSchema = z.object({
  file: z
    .array(z.custom<File>())
...
export const employmentTypeExportSchema = z
  .object({
...
export type EmploymentTypeImportFormData = z.infer<
  typeof employmentTypeImportSchema
>
export type EmploymentTypeExportFormData = z.infer<
  typeof employmentTypeExportSchema
>
