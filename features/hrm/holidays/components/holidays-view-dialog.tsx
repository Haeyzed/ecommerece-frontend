...
function HolidaysView({ className, currentRow }: HolidaysViewProps) {
  const status =
    (currentRow as any).approve_status ||
    (currentRow.is_approved ? 'approved' : 'unapproved')
        ...
        <div className='space-y-2'>
          ...
          <div className='text-sm font-medium'>
            {currentRow.from_date
              ? format(new Date(currentRow.from_date), 'MMMM dd, yyyy')
              : 'N/A'}
          </div>
        </div>
        <div className='space-y-2'>
          ...
          <div className='text-sm font-medium'>
            {currentRow.to_date
              ? format(new Date(currentRow.to_date), 'MMMM dd, yyyy')
              : 'N/A'}
          </div>
        </div>
      </div>
