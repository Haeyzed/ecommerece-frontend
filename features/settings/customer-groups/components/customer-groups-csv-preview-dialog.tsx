...
type CustomerGroupsCsvPreviewDialogProps = {
  open: boolean
...
export function CustomerGroupsCsvPreviewDialog({
  open,
  onOpenChange,
  data,
  onConfirm,
  isPending,
}: CustomerGroupsCsvPreviewDialogProps) {
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className='sm:max-w-3xl'>
          <DialogHeader className='text-start'>
            ...
            <DialogDescription>
              Review the data before importing. Showing first 5 rows of{' '}
              {data.length} entries.
            </DialogDescription>
          </DialogHeader>
