...
export function DataTableBulkActions<TData>({
  ...
  const { mutate: activateCategories, isPending: isActivating } =
    useBulkActivateCategories()
  const { mutate: deactivateCategories, isPending: isDeactivating } =
    useBulkDeactivateCategories()
