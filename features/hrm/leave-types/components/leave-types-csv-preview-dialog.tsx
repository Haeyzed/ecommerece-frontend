...
type LeaveTypesCsvPreviewDialogProps = {
  open: boolean
...
export function LeaveTypesCsvPreviewDialog({
                                             open,
                                             onOpenChange,
                                             data,
                                             onConfirm,
                                             isPending,
                                           }: LeaveTypesCsvPreviewDialogProps) {
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className='sm:max-w-4xl'>
          <DialogHeader className='text-start'>
            <DialogTitle>Preview Import Leave Types Data</DialogTitle>
            <DialogDescription>
              Review the leave types data before importing. Showing first 5 rows of {data.length} entries.
            </DialogDescription>
          </DialogHeader>
    ...
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerContent>
        <DrawerHeader className='text-left'>
          <DrawerTitle>Preview Import Leave Types Data</DrawerTitle>
          <DrawerDescription>
            Review the leave types data before importing. Showing first 5 rows of {data.length} entries.
          </DrawerDescription>
        </DrawerHeader>
