              ...
              <>
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      {isEnablingFeatured ? <Spinner className="size-4" /> :
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      {isDisablingFeatured ? <Spinner className="size-4" /> :
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      {isEnablingSync ? <Spinner className="size-4" /> :
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      {isDisablingSync ? <Spinner className="size-4" /> :
                        <HugeiconsIcon icon={DatabaseSyncIcon} strokeWidth={2} />}
                    </Button>
                  </TooltipTrigger>
