  ...
  return (
    <NodeViewWrapper
      ...
      className={cn(
        ...
        node.attrs.align === "left" && "start-0 -translate-x-0 rtl:translate-x-0",
        node.attrs.align === "center" && "start-1/2 -translate-x-1/2 rtl:translate-x-1/2",
        node.attrs.align === "right" && "start-full -translate-x-full rtl:translate-x-full"
      )}
    ...
    >
      ...
      >
        ...
        {editor?.isEditable && (
          <div
            className={cn(
              "absolute end-4 top-4 flex items-center gap-1 rounded-md border bg-background/80 p-1 opacity-0 backdrop-blur transition-opacity",
