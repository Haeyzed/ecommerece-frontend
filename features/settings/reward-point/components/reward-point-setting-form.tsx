        ...
        <CardContent className='space-y-4'>
          <FieldGroup>
              ...
              render={({ field }) => (
                <Field className='flex flex-row items-center justify-between rounded-md border p-4'>
                  <div className='space-y-0.5'>
                    ...
                    <FieldDescription>
                      Enable reward points for customers.
                    </FieldDescription>
                  </div>
                  <Switch
                    id='is_active'
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  <FieldLabel htmlFor='per_point_amount'>
                    Sold amount per point
                  </FieldLabel>
                  <FieldDescription>
                    For example, 100 means for every 100 spent the customer gets
                    1 point.
                  </FieldDescription>
                  <Input
                    id='per_point_amount'
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  <FieldLabel htmlFor='minimum_amount'>
                    Minimum sold amount to get point
                  </FieldLabel>
                  <FieldDescription>
                    Customer only gets points if order total reaches this
                    amount.
                  </FieldDescription>
                  <Input
                    id='minimum_amount'
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  ...
                  <FieldDescription>
                    Duration after which earned points expire.
                  </FieldDescription>
                  <Input
                    id='duration'
                    type='number'
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  ...
                  <FieldDescription>
                    Whether the expiry duration is in days, months, or years.
                  </FieldDescription>
                  <Select
        ...
        <CardContent className='space-y-4'>
          <FieldGroup>
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  <FieldLabel htmlFor='redeem_amount_per_unit_rp'>
                    Redeem amount per unit point
                  </FieldLabel>
                  <FieldDescription>
                    Monetary value each point can be redeemed for.
                  </FieldDescription>
                  <Input
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  <FieldLabel htmlFor='min_order_total_for_redeem'>
                    Minimum order total to redeem points
                  </FieldLabel>
                  <FieldDescription>
                    Customer can only redeem if order total reaches this amount.
                  </FieldDescription>
                  <Input
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  <FieldLabel htmlFor='min_redeem_point'>
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  <FieldLabel htmlFor='max_redeem_point'>
                    Maximum redeem point per order
                  </FieldLabel>
                  <FieldDescription>
                    Set 0 for unlimited redeem per order.
                  </FieldDescription>
                  <Input
                    id='max_redeem_point'
                    type='number'
