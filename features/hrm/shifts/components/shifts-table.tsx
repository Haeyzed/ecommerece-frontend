...
import { usePaginatedShifts } from '@/features/hrm/shifts/api'
import { DataTableBulkActions, shiftsColumns as columns, ShiftsEmptyState } from '@/features/hrm/shifts'
...
export function ShiftsTable() {
  ...
  const { data, isLoading, error } = usePaginatedShifts(apiParams)
  ...
  return (
    <div className={cn('max-sm:has-[div[role="toolbar"]]:mb-16', 'flex flex-1 flex-col gap-4')}>
      <DataTableToolbar
        table={table}
        searchPlaceholder="Filter shifts..."
        searchKey="name"
        dateRange={dateRange}
