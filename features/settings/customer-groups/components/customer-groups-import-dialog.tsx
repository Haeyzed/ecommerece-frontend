...
export function CustomerGroupsImportDialog({
  ...
  const form = useForm<CustomerGroupImportFormData>({
    resolver: zodResolver(customerGroupImportSchema),
    defaultValues: { file: [] },
  })
  ...
  const handlePreview = (data: CustomerGroupImportFormData) => {
    ...
    >
      ...
      <FieldGroup>
        <div className="space-y-2 rounded-md border bg-muted/50 p-3 text-sm">
          <div className="font-medium">Required: name, percentage</div>
          <div className="text-muted-foreground">Optional: is_active</div>
        </div>
        <Controller
          ...
          render={({ field: { value, onChange }, fieldState }) => (
            <Field data-invalid={!!fieldState.error}>
              ...
              <FieldDescription>Upload the file containing your customer group data.</FieldDescription>
  ...
  return (
    <>
        ...
        <Dialog open={open} onOpenChange={handleOpenChange}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader className="text-start">
              <DialogTitle>Import Customer Groups</DialogTitle>
              <DialogDescription>
                Bulk create customer groups by uploading a CSV or Excel file.
              </DialogDescription>
            </DialogHeader>
            <ImportContent />
        ...
        <Drawer open={open} onOpenChange={handleOpenChange}>
          <DrawerContent>
            <DrawerHeader className="text-left">
              <DrawerTitle>Import Customer Groups</DrawerTitle>
              <DrawerDescription>
                Bulk create customer groups by uploading a CSV or Excel file.
              </DrawerDescription>
            </DrawerHeader>
            ...
            <DrawerFooter>
              <Button type="submit" form="cg-import-form" disabled={!form.formState.isValid}>
                Preview Data
                <HugeiconsIcon icon={ViewIcon} strokeWidth={2} className="ml-2 size-4" />
              </Button>
              <DrawerClose asChild>
      ...
      <CustomerGroupsCsvPreviewDialog
        open={previewOpen}
