      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className='sm:max-w-lg'>
          <DialogHeader className='text-start'>
            ...
            <DialogDescription>
              {isEdit
                ? 'Update the leave type details here. '
      ...
      <FieldGroup>
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={!!fieldState.error}>
              <FieldLabel htmlFor='leave-type-name'>
        ...
        <div className='grid grid-cols-2 gap-4'>
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={!!fieldState.error}>
                <FieldLabel htmlFor='annual-quota'>
                  Annual Quota (Days){' '}
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={!!fieldState.error}>
                <FieldLabel htmlFor='carry-forward'>
                  Carry Forward Limit{' '}
                  <span className='text-destructive'>*</span>
                </FieldLabel>
                <Input
          ...
          render={({ field, fieldState }) => (
            ...
            >
              <div className='space-y-0.5'>
                <FieldLabel htmlFor='leave-type-encashable'>
                  Encashable
                </FieldLabel>
                <FieldDescription>
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            ...
            >
              <div className='space-y-0.5'>
                <FieldLabel htmlFor='leave-type-active'>
                  Active Status
                </FieldLabel>
                <FieldDescription>
