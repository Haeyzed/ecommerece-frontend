      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className='sm:max-w-lg'>
          <DialogHeader className='text-start'>
            ...
            <DialogDescription>
              {isEdit
                ? 'Update the document type details here. '
                : 'Create a new document type here. '}
      ...
      <FieldGroup>
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={!!fieldState.error}>
              <FieldLabel htmlFor='document-type-name'>
          ...
          render={({ field, fieldState }) => (
            ...
            >
              <div className='space-y-0.5'>
                <FieldLabel htmlFor='document-type-requires-expiry'>
                  Requires Expiry
                </FieldLabel>
                <FieldDescription>
                  If enabled, an expiry date will be mandatory for documents of
                  this type.
                </FieldDescription>
              </div>
              <Switch
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            ...
            >
              <div className='space-y-0.5'>
                <FieldLabel htmlFor='document-type-active'>
                  Active Status
                </FieldLabel>
                <FieldDescription>
