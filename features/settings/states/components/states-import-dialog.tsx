...
import { type StateImportFormData, stateImportSchema } from '@/features/settings/states/schemas'
    ...
    <form id="import-form" onSubmit={form.handleSubmit(handlePreview)} className="grid gap-4 py-4">
      ...
      <FieldGroup>
        <div className="space-y-2 rounded-md border bg-muted/50 p-3 text-sm">
          ...
          <ul className="list-disc list-inside space-y-1 text-muted-foreground">
            <li><code className="rounded bg-background px-1 py-0.5 text-xs">code</code>, <code
              className="rounded bg-background px-1 py-0.5 text-xs">state_code</code></li>
