...
import {
  useTimezonesImport,
  useTimezonesTemplateDownload,
} from '@/features/settings/timezones/api'
import {
  type TimezoneImportFormData,
  timezoneImportSchema,
...
export function TimezonesImportDialog({
  open,
  onOpenChange,
  ...
  const form = useForm<TimezoneImportFormData>({
    resolver: zodResolver(timezoneImportSchema),
    defaultValues: {
      file: [],
    },
  })
  ...
  const handlePreview = (data: TimezoneImportFormData) => {
        ...
        <div className='space-y-2 rounded-md border bg-muted/50 p-3 text-sm'>
          ...
          <ul className='list-inside list-disc space-y-1 text-muted-foreground'>
            <li>
              ...
              - Timezone name (e.g. Africa/Lagos)
            </li>
            <li>
              <code className='rounded bg-background px-1 py-0.5 text-xs'>
                country_id*
        ...
        <Controller
          ...
          render={({
            ...
            <Field data-invalid={!!fieldState.error}>
              ...
              <FieldDescription>
                Upload the file containing your timezone data.
              </FieldDescription>
        ...
        <Drawer open={open} onOpenChange={handleOpenChange}>
          <DrawerContent>
            <DrawerHeader className='text-left'>
              <DrawerTitle>Import Timezones</DrawerTitle>
              <DrawerDescription>
                Bulk create timezones by uploading a CSV or Excel file.
              </DrawerDescription>
            </DrawerHeader>
