...
import { useCurrencies } from '@/features/settings/currencies/api'
import { CurrenciesEmptyState } from './currencies-empty-state'
...
export function CurrenciesTable() {
  ...
  const { data, isLoading, error } = useCurrencies(apiParams)
  ...
  if (!isLoading && !hasData && !isFiltered) return <CurrenciesEmptyState />

  return (
    <div className={cn('max-sm:has-[div[role="toolbar"]]:mb-16', 'flex flex-1 flex-col gap-4')}>
      <DataTableToolbar table={table} searchPlaceholder="Filter currencies..." searchKey="name" />
