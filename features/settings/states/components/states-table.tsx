...
import { useStates } from '@/features/settings/states/api'
import { StatesEmptyState } from './states-empty-state'
import { DataTableBulkActions } from './data-table-bulk-actions'
import { statesColumns as columns } from './states-columns'
...
export function StatesTable() {
  ...
  const { data, isLoading, error } = useStates(apiParams)
  ...
  if (!isLoading && !hasData && !isFiltered) return <StatesEmptyState />

  return (
    <div className={cn('max-sm:has-[div[role="toolbar"]]:mb-16', 'flex flex-1 flex-col gap-4')}>
      <DataTableToolbar table={table} searchPlaceholder="Filter states..." searchKey="name" />
