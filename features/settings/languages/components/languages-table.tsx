...
import { LanguagesEmptyState } from './languages-empty-state'
import { languagesColumns as columns } from './languages-columns'
...
export function LanguagesTable() {
  ...
  if (!isLoading && !hasData && !isFiltered) return <LanguagesEmptyState />

  return (
    <div className={cn('max-sm:has-[div[role="toolbar"]]:mb-16', 'flex flex-1 flex-col gap-4')}>
      <DataTableToolbar table={table} searchPlaceholder="Filter languages..." searchKey="name" />
