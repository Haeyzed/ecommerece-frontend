...
import { type CurrencyImportFormData, currencyImportSchema } from '@/features/settings/currencies/schemas'
      ...
      <FieldGroup>
        <div className="space-y-2 rounded-md border bg-muted/50 p-3 text-sm">
          ...
          <ul className="list-disc list-inside space-y-1 text-muted-foreground">
            ...
            <li><code className="rounded bg-background px-1 py-0.5 text-xs">symbol*</code> - Currency symbol (e.g. $)
            </li>
          ...
          <ul className="list-disc list-inside space-y-1 text-muted-foreground">
            <li><code className="rounded bg-background px-1 py-0.5 text-xs">precision</code>, <code
              className="rounded bg-background px-1 py-0.5 text-xs">symbol_native</code></li>
            <li><code className="rounded bg-background px-1 py-0.5 text-xs">decimal_mark</code>, <code
              className="rounded bg-background px-1 py-0.5 text-xs">thousands_separator</code></li>
