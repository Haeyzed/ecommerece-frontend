...
export const countrySchema = z.object({
  ...
  iso3: z.string().max(3).optional().nullable(),
  region: z.string().max(255).optional().nullable(),
  subregion: z.string().max(255).optional().nullable(),
  native: z.string().max(255).optional().nullable(),
  latitude: z.string().max(255).optional().nullable(),
  longitude: z.string().max(255).optional().nullable(),
  emoji: z.string().max(191).optional().nullable(),
  emojiU: z.string().max(191).optional().nullable(),
});

export const countryImportSchema = z.object({
  file: z
    .array(z.custom<File>())
...
export const countryExportSchema = z
  .object({
