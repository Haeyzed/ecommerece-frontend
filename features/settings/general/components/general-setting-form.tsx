        ...
        <CardContent className='space-y-4'>
          <FieldGroup>
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  <FieldLabel htmlFor='vat_registration_number'>
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  ...
                  <Input
                    id='currency'
                    placeholder='Currency code or ID'
                    {...field}
                    value={field.value ?? ''}
                  />
                  {fieldState.error && (
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  ...
                  <Select
                    value={field.value ?? ''}
                    onValueChange={(v) =>
                      field.onChange((v as 'all' | 'own' | 'warehouse') || null)
                    }
                  >
                    <SelectTrigger>
        ...
        <CardContent className='space-y-4'>
          <FieldGroup>
              ...
              render={({ field }) => (
                <Field>
                  <div className='flex items-center gap-2'>
                    ...
                    />
                    <FieldLabel
                      htmlFor='show_products_details_in_sales_table'
                      className='font-normal'
                    >
              ...
              render={({ field }) => (
                <Field>
                  <div className='flex items-center gap-2'>
                    ...
                    />
                    <FieldLabel
                      htmlFor='show_products_details_in_purchase_table'
                      className='font-normal'
                    >
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  ...
                  <Select
                    value={field.value ?? ''}
                    onValueChange={(v) =>
                      field.onChange((v as 'standard' | 'gst') || null)
                    }
                  >
                    <SelectTrigger>
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  <FieldLabel htmlFor='expiry_alert_days'>
                    Expiry alert (days)
                  </FieldLabel>
                  <FieldDescription>
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  ...
                  <Select
                    value={field.value != null ? String(field.value) : ''}
                    onValueChange={(v) =>
                      field.onChange(v ? (Number(v) as 0 | 1) : null)
                    }
                  >
                    <SelectTrigger>
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  <FieldLabel htmlFor='default_margin_value'>
                    Default profit margin value
                  </FieldLabel>
                  <Input
        ...
        <CardContent className='space-y-4'>
          <FieldGroup>
              ...
              render={({ field }) => (
                <Field>
                  <div className='flex items-center gap-2'>
                    ...
                    />
                    <FieldLabel
                      htmlFor='disable_forgot_password'
                      className='font-normal'
                    >
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  <FieldLabel htmlFor='maintenance_allowed_ips'>
                    Maintenance allowed IPs
                  </FieldLabel>
                  <FieldDescription>
                    Comma-separated IPs allowed when maintenance mode is on.
        ...
        <CardContent className='space-y-4'>
          <FieldGroup>
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  <FieldLabel htmlFor='auth_css'>
                    Auth pages CSS (login, registration, etc.)
                  </FieldLabel>
                  <InputGroup className='h-auto'>
                    <InputGroupAddon align='block-start' className='border-b'>
                      <InputGroupText className='font-mono font-medium'>
