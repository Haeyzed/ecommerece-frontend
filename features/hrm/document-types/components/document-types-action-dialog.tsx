...
import { useCreateDocumentType, useUpdateDocumentType } from '@/features/hrm/document-types/api'
import { type DocumentTypeFormData, documentTypeSchema } from '@/features/hrm/document-types/schemas'
