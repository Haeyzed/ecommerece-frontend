...
import { currencyExportSchema, type CurrencyExportFormData } from '@/features/settings/currencies/schemas'
...
const AVAILABLE_COLUMNS = [
  ...
  { value: 'symbol_native', label: 'Native Symbol' },
  { value: 'symbol_first', label: 'Symbol First' },
  { value: 'decimal_mark', label: 'Decimal Mark' },
  { value: 'thousands_separator', label: 'Thousands Separator' },
  { value: 'country_id', label: 'Country ID' },
  { value: 'created_at', label: 'Created At' },
  { value: 'updated_at', label: 'Updated At' },
] as const

type CurrenciesExportDialogProps = {
  open: boolean
...
export function CurrenciesExportDialog({
  ...
  const form = useForm<CurrencyExportFormData>({
    resolver: zodResolver(currencyExportSchema),
    defaultValues: {
      format: 'excel',
      method: 'download',
      columns: ['id', 'name', 'code', 'symbol', 'country_id'],
  ...
  const onSubmit = (data: CurrencyExportFormData) => {
    exportCurrencies(
      {
