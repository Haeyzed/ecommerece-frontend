...
import {
  type LeaveTypeImportFormData,
  leaveTypeImportSchema,
  LeaveTypesCsvPreviewDialog,
  useLeaveTypesImport,
  useLeaveTypesTemplateDownload,
      ...
      <FieldGroup>
        <div className="space-y-2 rounded-md border bg-muted/50 p-3 text-sm">
          ...
          <ul className="list-disc list-inside space-y-1 text-muted-foreground">
            ...
            <li><code className="rounded bg-background px-1 py-0.5 text-xs">carry_forward_limit*</code> - Numeric value
            </li>
          </ul>
