...
export function Hero() {
  return (
    <section
      className="relative w-full overflow-hidden bg-gradient-to-b from-background via-background to-muted/30 py-12 sm:py-20 lg:py-28">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          {/* Main Headline */}
          <h1
            className="mb-6 max-w-4xl text-3xl font-bold tracking-tight text-foreground sm:text-4xl md:text-5xl lg:text-6xl">
            Discover Premium Products at Unbeatable Prices
          </h1>

          {/* Subheadline */}
          <p className="mb-8 max-w-2xl text-base text-muted-foreground sm:text-lg md:text-xl">
            Shop from our curated collection of high-quality products. Fast shipping, secure checkout, and 24/7 customer
            support.
          </p>
