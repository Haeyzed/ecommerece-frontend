...
export function IconThemeDark(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      {/* Content Area Background - Darker contrast (#0a0a0a) */}
      <path
        d='M22.88 0h52.97c2.21 0 4 1.79 4 4v43.14c0 2.21-1.79 4-4 4H22.88V0z'
        fill='#0a0a0a'
      />
      
      {/* Sidebar Avatar - mapped to --muted (#525252) */}
      <circle cx={6.7} cy={7.04} r={3.54} fill='#525252' />
      
      {/* Sidebar Text Lines - mapped to --muted (#525252) */}
      <path
      ...
      {/* Bottom Card - mapped to --card (#333333) */}
      <rect
        x={29.64}
        y={27.75}
        width={41.62}
