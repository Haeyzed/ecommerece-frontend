...
import {
  type EmploymentTypeImportFormData,
  EmploymentTypesCsvPreviewDialog,
  employmentTypeImportSchema,
  useEmploymentTypesImport,
  useEmploymentTypesTemplateDownload,
} from '@/features/hrm/employment-types'

type EmploymentTypesImportDialogProps = {
  open: boolean
  onOpenChange: (open: boolean) => void
}

export function EmploymentTypesImportDialog({
  open,
  onOpenChange,
}: EmploymentTypesImportDialogProps) {
  const isDesktop = useMediaQuery('(min-width: 768px)')
  const { mutate: importEmploymentTypes, isPending } = useEmploymentTypesImport()
  ...
  const form = useForm<EmploymentTypeImportFormData>({
    resolver: zodResolver(employmentTypeImportSchema),
    defaultValues: {
      file: [],
    },
  })
  ...
  const handlePreview = (data: EmploymentTypeImportFormData) => {
          ...
          render={({
            ...
            <Field data-invalid={!!fieldState.error}>
              ...
              <FileUpload
                ...
                accept='.csv, application/vnd.openxmlformats-officeemployment.spreadsheetml.sheet, application/vnd.ms-excel'
                maxFiles={1}
              ...
              <FieldDescription>
                Upload the file containing your employment types data.
              </FieldDescription>
        ...
        <Dialog open={open} onOpenChange={handleOpenChange}>
          <DialogContent className='sm:max-w-md'>
            <DialogHeader className='text-start'>
              ...
              <DialogDescription>
                Bulk create employment types by uploading a CSV or Excel file.
              </DialogDescription>
            </DialogHeader>
