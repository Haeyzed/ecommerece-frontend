...
export function DataTableBulkActions<TData>({
  ...
  const { mutate: activateCustomerGroups, isPending: isActivating } =
    useBulkActivateCustomerGroups()
  const { mutate: deactivateCustomerGroups, isPending: isDeactivating } =
    useBulkDeactivateCustomerGroups()
  ...
  const handleBulkStatusChange = (status: 'active' | 'inactive') => {
    if (status === 'active') {
      activateCustomerGroups(selectedIds, {
        onSuccess: () => table.resetRowSelection(),
      })
    } else {
      deactivateCustomerGroups(selectedIds, {
        onSuccess: () => table.resetRowSelection(),
      })
    }
  }
      ...
      <BulkActionsToolbar table={table} entityName='customer group'>
        {canUpdate && (
          <>
            <Tooltip>
              ...
              <TooltipContent>
                <p>Activate selected customer groups</p>
              </TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
              ...
              <TooltipContent>
                <p>Deactivate selected customer groups</p>
              </TooltipContent>
            </Tooltip>
          </>
        )}
        {canExport && (
          <Tooltip>
            ...
            <TooltipContent>
              <p>Export selected customer groups</p>
            </TooltipContent>
          </Tooltip>
        )}
        {canDelete && (
          <Tooltip>
            ...
            <TooltipContent>
              <p>Delete selected customer groups</p>
            </TooltipContent>
          </Tooltip>
        )}
      </BulkActionsToolbar>
