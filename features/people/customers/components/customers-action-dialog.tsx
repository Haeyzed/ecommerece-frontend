      ...
      <FieldGroup>
        <Controller
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={!!fieldState.error} className='flex flex-col'>
              <FieldLabel htmlFor='customer-group'>
                Customer group <span className='text-destructive'>*</span>
              </FieldLabel>
              <Combobox
                items={groupOptions}
                itemToStringLabel={(item) => item.label}
                value={
                  groupOptions.find((p) => p.value === field.value) ?? null
                }
                onValueChange={(item) =>
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={!!fieldState.error} className='flex flex-col'>
              ...
              <Combobox
                ...
                itemToStringLabel={(item) => item.label}
                value={
                  countryOptions.find((p) => p.value === field.value) ?? null
                }
                onValueChange={(item) => {
          ...
          render={({ field, fieldState }) => (
            <Field data-invalid={!!fieldState.error} className='flex flex-col'>
              ...
              <Combobox
                ...
                itemToStringLabel={(item) => item.label}
                value={
                  stateOptions.find((p) => p.value === field.value) ?? null
                }
                onValueChange={(item) => {
                  field.onChange(item?.value ?? null)
                  form.setValue('city_id', undefined)
        ...
        <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={!!fieldState.error}>
                <FieldLabel htmlFor='customer-opening'>
                  Opening balance
                </FieldLabel>
                <Input
                  id='customer-opening'
        ...
        <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={!!fieldState.error}>
                <FieldLabel htmlFor='customer-pay-term-no'>
                  Pay term (number)
                </FieldLabel>
                <Input
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={!!fieldState.error}>
                <FieldLabel htmlFor='customer-pay-term-period'>
                  Pay term period
                </FieldLabel>
                <Input
                  id='customer-pay-term-period'
            ...
            >
              <div className='space-y-0.5'>
                ...
                <span className='text-xs text-muted-foreground'>
                  Disabling this will hide the customer from the system.
                </span>
              </div>
              <Switch
                id='customer-active'
        ...
        <Controller
          ...
          render={({ field }) => (
            <Field className='flex flex-row items-center justify-between rounded-md border p-4'>
              <div className='space-y-0.5'>
                <FieldLabel htmlFor='customer-both'>
                  Also register as supplier
                </FieldLabel>
                <FieldDescription>
                  Create a supplier record for this contact so they can be used
                  for purchases.
                </FieldDescription>
              </div>
              <Switch
        ...
        <Controller
          ...
          render={({ field }) => (
            <Field className='flex flex-row items-center justify-between rounded-md border p-4'>
              <div className='space-y-0.5'>
                <FieldLabel htmlFor='customer-user'>
                  Create portal login
                </FieldLabel>
                <FieldDescription>
                  Allow this customer to sign in with a username and password to
        ...
        {user && (
          <>
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={!!fieldState.error}>
                  <FieldLabel htmlFor='customer-username'>
